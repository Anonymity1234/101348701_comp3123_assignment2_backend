...
export default function Update() {
    ...
    const updateAPIData = () => {
        axios.put(`https://101348701-comp3123-assignment2-backend.vercel.app/api/emp/employees/${id}`, {
            first_name,
            last_name,
            email,
            gender,
                ...
                <div class="mt-4 bg-white shadow-md rounded-lg text-left">
                    ...
                    <div class="px-8 py-6 ">
                        ...
                        <div class="flex justify-between items-baseline">
                            <button onClick={updateAPIData} type="submit" class="mt-4 bg-orange-500 text-white py-2 px-6 rounded-md hover:bg-orange-600 ">Update</button>
                            <Link to='/view'>
                                <button  class="mt-4 bg-orange-500 text-white py-2 px-6 rounded-md hover:bg-orange-600 ">Back</button>
                            </Link>
